...
const experiences = [
  {
    ...
    description: "Leading software development for autonomous drones. Engineered solutions for real-time navigation and object detection.",
    achievement: "🏆 1st Place at National PakUAS 2024",
  ...
  },
  {
    ...
    description: "Engineered official documentation platform using modern web technologies. Implemented interactive 'scrollycoding' features for enhanced UX.",
